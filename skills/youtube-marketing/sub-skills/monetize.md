...
description: >
  Revenue strategy across 7 streams for product-company YouTube channels.
  Not ad-revenue focused — built for WordPress plugin companies using YouTube
  as a sales channel. Maps each video type to its highest-converting CTA.
---

# /youtube monetize

## Research Foundation
- **ConversionXL, 2024**: Plugin demo videos convert at 2.8% avg; with live demo on landing page: 6%+
- **Demand Curve, 2025**: SaaS/plugin companies that use YouTube as primary acquisition channel see $3–8 LTV per subscriber (vs $0.001 CPM for ad revenue)
- **YouTube CPM seasonality**: Q4 (Oct–Dec) CPM is 40–60% higher — push product CTAs and paid offers in Q4
- **Email ROI (Mailchimp 2025)**: Email subscribers from YouTube = 3.5x lifetime value of social followers
- **Affiliate benchmark**: WordPress niche affiliates earn $15–50 per referral; plugin bundles earn $30–100
...
**Optimize this first.** It's the highest-LTV channel. One Pro sale at $49 >> 50,000 ad views.

### Stream 2 — Affiliate Partnerships
**How**: Partner with complementary WordPress products (not competitors). Promote in relevant videos.
**Good categories**:
- Hosting (WP Engine, Cloudways, Hostinger) — $50–150/referral
...
**Rate benchmark** (10K–50K subs, WordPress niche): $200–800 per integration

**How to approach**: Only sponsor products you actually use. One bad sponsored video destroys 3 months of trust.
...
| Stream | Priority | Effort | LTV/Unit | When to Focus |
|--------|----------|--------|----------|--------------|
| Plugin sales (Stream 1) | 🥇 FIRST | Low (already in desc) | $49–200 | Always |
| Email list (Stream 4) | 🥈 SECOND | Medium | $30–120 lifetime | Start now |
| Affiliate (Stream 2) | 🥉 THIRD | Low (add links) | $15–150/ref | Once 2K+ subs |
| Ad revenue (Stream 3) | 4th | None | $0.001–0.004/view | Already active |
| Sponsorships (Stream 5) | 5th | High | $200–800/video | After 25K subs |
| Course (Stream 6) | 6th | Very high | $49–99/student | After 25K subs |
| Membership (Stream 7) | Last | High | $5–15/month | After engagement fixed |

## CTA Map by Video Type
...
```
# MONETIZATION AUDIT — [Channel / Video]
Date: [today]

━━━━━━━━━━━━━━━━━━━━━━━━━━━━
## CURRENT REVENUE SOURCES (active)

[List what's generating money now + estimated amounts]

━━━━━━━━━━━━━━━━━━━━━━━━━━━━
## GAPS (money left on table)

[Revenue streams not yet active + why they're worth starting]

━━━━━━━━━━━━━━━━━━━━━━━━━━━━
## PRIORITY ACTIONS

1. [Highest-impact revenue action — plugin sales optimization]
2. [Second action — email capture or affiliate]
3. [Third action]
...
Stream 1 (plugin sales): [current views × estimated conversion × avg sale]
Stream 2 (affiliates): [if activated]
Stream 3 (ads): [RPM × monthly watch hours / 1000]
Total: [N]
```
